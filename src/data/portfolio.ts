...
const haisiReportEntries = [
  ['国家级媒体报道', '新华网', '“嘉庚”号科考船再启航将首次穿越赤道', '2025年7月24日', 'http://www.fj.xinhuanet.com/20250724/dbe58acd441e4dceaddfa0c11641498c/c.html'],
  ['国家级媒体报道', '人民网', '厦门大学“嘉庚”号科考船在雅加达举办公众开放日活动', '2025年8月9日', 'https://world.people.com.cn/n1/2025/0809/c1002-40539246.html'],
  ['国家级媒体报道', '新华网', '“嘉庚”号相关国际航次报道', '2025年8月8日', 'https://www.news.cn/world/20250808/7d9f96fb922d44ea869d32f323743fe0/c.html'],
  ['国家级媒体报道', '中国新闻网', '“嘉庚”号相关国际航次报道', '2025年8月8日', 'https://www.chinanews.com.cn/gj/2025/08-08/10461819.shtml'],
  ['国家级媒体报道', '亚太网', '“嘉庚”号相关亚太区域报道', '2025年8月12日', 'https://www.news.cn/asia/20250812/6a41fa7e65c946debfa32ba17c846ed2/c.html'],
  ['国家级媒体报道', '中国新闻网', '“嘉庚”号相关视频报道', '2025年8月8日', 'https://www.chinanews.com.cn/gj/shipin/cns-d/2025/08-08/news1027149.shtml'],
...
export const focusModules = [
  {
    icon: '∿',
    title: '算法与信号处理实践',
    detail: '将声学定位与控制理论，整理为可运行、可验证的程序实现。'
  },
  {
    icon: '⌁',
    title: '硬件与嵌入式实践',
    detail: '参与前置电路 PCB 绘制、多架构主控平台调试与嵌入式系统开发。'
  },
  {
    icon: '</>',
    title: '上层软件开发',
    detail: '搭建交互界面，串联信号处理、视觉识别与数据分析流程。'
  },
  {
    icon: '◎',
    title: '水下平台实测',
    detail: '以仿生潜水器为实验载体，参与水下感知与控制系统的联调和验证。'
  }
]

export const resume = {
  summary:
    '以海洋声学、水下通信与仿生机器人为主线，关注真实航次数据、声学电路、嵌入式系统与机器人平台验证之间的项目实践连接。',
  expeditions: [
    {
    ...
    sections: [
      {
        ...
        title: '仿生移动通信节点',
        body:
          '针对传统水声通信节点布放后难以主动调整位置与姿态的问题，受弹涂鱼启发，结合尾部推进、胸鳍支撑与两栖适应特征，尝试构建面向浅海及滩涂场景的移动载体。'
      },
      {
        eyebrow: 'System',
        title: '平台与水声链路一体化',
        body:
          '采用模块化集成设计，涵盖防水舱、推进机构、丝杆调姿模块及水声换能器。展示重点聚焦于硬件系统集成逻辑与控制流程，相关专利及算法细节均已脱敏处理。'
      },
      {
        eyebrow: 'Validation',
        title: '全流程实验与海试验证',
        body:
          '整理结构设计、实验测试与应用验证相关材料。展示材料包含水池运动测试、重心调姿趋势分析、LabVIEW 链路控制界面以及真实的海试现场记录。'
      }
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        title: '实验支撑材料',
        body:
          '通过波形、频谱、航次照片与实验记录，呈现从现场采集到数据分析的主要过程。'
      }
    ],
